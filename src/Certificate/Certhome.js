    ...
    return(
        ...
        <Modal.Body><div className={"text-danger card-body mb-3"}>
         ...
         {/*--------*/}
            {/*template*/}
            {/*--------*/}
                <h6 className={"mb-3"}><b style={{color:"#000",marginLeft:"450px",}} >
                    CHOOSE A TEMPLATE
                </b></h6>
            ...
            <Container>
                ...
                <Form onSubmit={handleSubmit}  style={{alignContent:"center",marginLeft:"280px"}}>
                  <Form.Group className="mb-3 col-sm-6" > 
                    <Form.Label style={{color:"#000"}}>Organization name:</Form.Label>
                    ...
                    <Form.Group className="mb-3 col-sm-6" >
                    <Form.Label style={{color:"#000"}}>Organization logo:</Form.Label>
                  ...
                  <Form.Group className="mb-3 col-sm-6">
                    <Form.Label style={{color:"#000"}}>Add Name:</Form.Label>
                    ...
                    <div  className={"mt-4"}>
                        <Button type="submit" variant={"light"}
                              className={"btn btn-outline-dark btn-xl"} style={{marginLeft:"150px"}}
                      >
            ...
            <h3><b style={{"color":"#000" ,marginLeft:"250px"}}>PREVIEW</b></h3>
